...
Adafruit_NeoPixel strip1(LED_COUNT, LED_PIN, NEO_GRBW + NEO_KHZ800);
...
void initLED() {
  ...
  uint32_t color1 = strip1.Color(0, 255, 0); // green
  uint32_t color2 = strip1.Color(0,0,255);   // blue

  colorWipe(strip1, color1);
